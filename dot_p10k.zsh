# Generated by Powerlevel10k configuration wizard on 2020-12-14 at 22:09 -03.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 49789.
# Wizard options: compatible, classic, unicode, dark, 24h time, flat heads,
# blurred tails, 2 lines, dotted, full frame, sparse, concise, instant_prompt=off.
